        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start">
            ...
            <a href="/" className="flex ml-2 md:mr-24">
              <img src="https://i.imgur.com/NsABj8L.png" className="h-8 mr-3" alt="Nisru Logo" />
              <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Nisru</span>
            </a>
          </div>
